...
TEST_CASE("VertexSelectionTests.testInitilizeEmptySelection")
{
    VertexSelection selection;
    
    CHECK_EQ(selection.size(), 0);
    CHECK(selection == VertexSelection({}));
}

TEST_CASE("VertexSelectionTests.testCountInitialization")
{
    VertexSelection selection(5);
    CHECK(selection == VertexSelection(5, {}));
}

TEST_CASE("VertexSelectionTests.testInitilizerList")
{
    VertexSelection selection{6, {1, 2, 3, 4, 5}};
    
    CHECK_EQ(selection.size(), 5);
    CHECK(selection == VertexSelection(6, {1, 2, 3, 4, 5}));
}

TEST_CASE("VertexSelectionTests.testCopy")
{
    VertexSelection src(10, {1, 2, 3, 4, 5});
    VertexSelection dst(10, {5, 6, 7, 8, 9});
    dst.copy(src);
    CHECK(dst == VertexSelection(10, {1, 2, 3, 4, 5}));
}

TEST_CASE("VertexSelectionTests.testClear")
{
    VertexSelection selection(6, {1, 2, 3, 4, 5});
    selection.clear();
    CHECK(selection == VertexSelection({}));
...
TEST_CASE("VertexSelectionTests.testConstructionFromVector")
{
    VertexSelection selection(4, std::vector<int>{2, 1, 3});
    CHECK(selection == VertexSelection(4, {1, 2, 3}));
}

TEST_CASE("VertexSelectionTests.testConstIterators")
{
...
TEST_CASE("VertexSelectionTests.testInsertIndex")
{
    VertexSelection selection(3);
    selection.insertValue(2);
    CHECK(selection == VertexSelection(3, {2}));
}

TEST_CASE("VertexSelectionTests.testIdempotentInsertion")
{
    VertexSelection selection;
    selection.insertValue(2);
    selection.insertValue(2);
...
TEST_CASE("VertexSelectionTests.testRemoveValue") {
    VertexSelection selection(4, {2, 3});
    selection.removeValue(2);
    CHECK(selection == VertexSelection(4, {3}));
}

TEST_CASE("VertexSelectionTests.testIdempotentRemoval")
{
    VertexSelection selection(4, {2, 3});
    selection.removeValue(2);
    selection.removeValue(2);
...
TEST_CASE("VertexSelectionTests.testUnionWith")
{
...
TEST_CASE("VertexSelectionTests.testComparison")
{
    ...
    CHECK(selection1 != selection3);
    
    VertexSelection selection4(6, {1, 2, 3, 4, 5, 6});
    CHECK(selection1 != selection4);
}

TEST_CASE("VertexSelectionTests.testGetTotalVertexCount")
{
    VertexSelection selection(6, {1, 2, 3, 4, 5});
    
    CHECK_EQ(selection.getTotalVertexCount(), 6);
}

TEST_CASE("VertexSelectionTests.testToVector")
{
    VertexSelection selection(6, {1, 2, 3, 4, 5});
    std::vector<int> vec{1, 2, 3, 4, 5};
    CHECK_EQ(selection.toVector(), vec);
}

TEST_CASE("VertexSelectionTests.testFromGeometry")
{
    ...
    CHECK(*viaPosition == VertexSelection(6, {2, 3}));
    ...
    CHECK(*viaNormal == VertexSelection(6, {3}));
    ...
    CHECK(*viaColor == VertexSelection(3, {2}));
}

TEST_CASE("VertexSelectionTests.testFromPolyline")
{
    std::vector<math::Vec3> positions{
        {+1.0f, +2.0f, +3.0f},
        {+6.0f, +7.0f, +8.0f},
    ...
    CHECK(selection == VertexSelection(4, {1, 2}));
}

TEST_CASE("VertexSelectionTests.testInvert")
{
    VertexSelection selection(7, {1, 2, 4});
    selection.invert();
    CHECK(selection == VertexSelection(7, {0, 3, 5, 6}));
    
    VertexSelection selection2(8, {1, 2, 4, 7});
    selection2.invert();
    CHECK(selection2 == VertexSelection(8, {0, 3, 5, 6}));
}

TEST_CASE("VertexSelectionTests.testInvertWRTGeometry")
{
    ...
    selection.invert();
    CHECK(selection == VertexSelection(geometry, {2}));
}
